...
<script>
	$(document).ready(function() {
		$(".btn-add").click(function() {
			...
			$.ajax({
				url : "/qc/qualityInspectionWrite", // 요청을 보낼 서버의 URL
		...
		<form role="form" id="fr">
			<table class="box" style="margin-top: 30px; width: 100%">
				<tbody>
					...
					<tr>
						<td>검사일</td>
						<td><input type="date" name="inspection_date"></td>
					</tr>
					<tr>
						<td>품목코드</td>
					...
					<tr>
						<td>검수량</td>
						<td><input type="number" name="iQTY"></td>
					</tr>
					<tr>
						<td>검사 세부 내용</td>
						<td><input type="text" name="inspection_comment"></td>
					</tr>
				</tbody>
			</table>
			<!--     <hr width="100%" style="border: 2px solid black"> -->
