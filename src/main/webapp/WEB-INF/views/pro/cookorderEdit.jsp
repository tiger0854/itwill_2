...
<form role="form" id="fr" method="post" action="">
			<table class="box" style="margin-top: 30px; width: 100%">
				<tbody>
					...
					<tr>
						<td>조리지시자</td>
						<td><input type="text" name="employee_id" value="${cvo.employee_id }"></td>
					</tr>
					<tr>
						<td>라인명</td>
					...
					<tr>
						<td>소요시간</td>
						<td><input type="text" name="co_time" value="${cvo.co_time }"></td>
					</tr>
					<tr>
						<td>지시상태</td>
					...
					<tr>
						<td>지시수량</td>
						<td><input type="number" name="coQTY" value=${cvo.coQTY }></td>
					</tr>										
				</tbody>
			</table>
<!--     <hr width="100%" style="border: 2px solid black"> -->
