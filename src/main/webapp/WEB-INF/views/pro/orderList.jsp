	...
	<div class="height-100">
		<div class="container mt-3">
					...
					<table class="product-box" style="margin-top: 20px; width: 100%;"
						...
						<tr>
							...
							<td><label> <input type="text" id="item_code"
									name="item_code" placeholder="품번" onclick="openItem()"
									width="100%" readonly> <i class='bx bx-search-alt-2'></i>
									<input type="text" id="item_name" placeholder="품명"
									style="border: 1px solid" readonly></td>
							</label>
							</td>
							<td>지시상태</td>
							<td colspan="8"><select name="wo_status">
			...
			<h4 style="margin-top: 100px;">
				<i class='bx bx-list-ol icon'></i> 작업지시 목록
			</h4>
			<span style="color: red; font-size: 13px">* 작업 지시 번호 클릭시 해당작업
				실적등록 가능 / 상품번호 클릭시 해당 레시피 확인가능</span>
