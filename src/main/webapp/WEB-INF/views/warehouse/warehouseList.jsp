...
function warehousewrite() {
  // 새 창을 열기 위한 URL
  var popupUrl = '/warehouse/warehouseWrite';
  // 새 창 열기
...
function warehouseedit() {
	  // 새 창을 열기 위한 URL
	  var popupUrl = '/warehouse/warehouseEdit';
	  // 새 창 열기
	  window.open(popupUrl, '_blank', 'width=500,height=600,resizable=yes');
	}
...
<button class=btn-add onclick="warehousewrite()"><i class='bx bx-plus-medical'></i> 창고 추가</button>
</div>
  ...
  <table class="product-table"style="margin-top: 20px;width: 100%;">
    ...
    <tbody>
      <tr>
        ...
        <td>사용여부</td>
        <td>구분</td>
        <td><button class=btn-edit onclick="warehouseedit()"><i class='bx bx-edit'></i></button></td>
