  ...
  <table class="product-table"style="margin-top: 20px;width: 100%;">
    ...
    <tbody>
      ...
      function warehouseDelete(){
    		if(confirm("창고명 : ${vo.wh_name}를/을 정말로 삭제하시겠습니까?")){
    			location.href='warehouseDelete?wh_code=${vo.wh_code}';
    		}
    	}
      </script>
      <tr>
        ...
        <td><button class=btn-delete onclick=warehouseDelete() ><i class='bx bxs-trash'></i></button></td>
      </tr>
      </c:forEach>
