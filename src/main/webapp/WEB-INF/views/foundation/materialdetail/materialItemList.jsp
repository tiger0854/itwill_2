	...
	<div class="container mt-3">
		...
		<table class="table table-hover" style="text-align: center;">
			...
			<c:forEach var="vo" items="${materialList }">
				<tr
					onclick="selectItem('${vo.material_code}', '${vo.material_name}', '${vo.material_type}')">
			...
			<ul class="pagination justify-content-center" id="pagination"
				...
				<c:if test="${pageVO.startPage > pageVO.pageBlock}">
					<li class="page-item"><a class="page-link"
						href="/foundation/materialdetail/materialItemList?material_code=${Search.material_code }&material_name=${Search.material_name }&pageNum=${pageVO.startPage - pageVO.pageBlock}"><sapn>
							< </sapn></a></li>
				</c:if>
				<c:forEach var="i" begin="${pageVO.startPage}"
					end="${pageVO.endPage}" step="1">
					<li class="page-item"><a class="page-link"
						href="/foundation/materialdetail/materialItemList?material_code=${Search.material_code }&material_name=${Search.material_name }&pageNum=${i}"><span>${i}</span></a></li>
				</c:forEach>
				<c:if test="${pageVO.endPage < pageVO.pageCount}">
					<li class="page-item"><a class="page-link"
						href="/foundation/materialdetail/materialItemList?material_code=${Search.material_code }&material_name=${Search.material_name }&pageNum=${pageVO.startPage + pageVO.pageBlock}"><span>
								> </span></a></li>
				</c:if>
			</ul>
		</div>
