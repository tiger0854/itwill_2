  ...
  <form action=""method="get">
    <div class="input-group mb-3"style="width: 600px;justify-content: flex-start;align-items: center; justify-content: space-between;">
      	...
      	<select class="form-select"style="max-width: 150px;margin-right: 5px;" name="state" id="state" >
			  ...
			  <option value="input">납입처</option>
			  <option value="output">납품처</option>
		</select>
	 	...
	 	<ul class="pagination"style="justify-content: center;">			
			...
			<c:forEach var="i" begin="${pageVO.startPage}" end="${pageVO.endPage}" step="1">
				<c:choose>
					...
					<li class="page-item ${pageVO.pageNum eq i ? 'active' : ''}"><a href="/customer/customerList?pageNum=${i}&kind=${pageVO.kind}&search=${pageVO.search}&state=${pageVO.state}" style="margin: 0.5em;border-radius: 2px;"  class="page-link">${i}</a></li>
					</c:when>
					<c:otherwise>
