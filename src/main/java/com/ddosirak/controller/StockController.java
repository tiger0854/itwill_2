...
///////////////////////////////////////////////////관리//////////////////////////////////////////////////////////////////////////////
	...
	public void stockListGET() {
		...
		logger.debug("/stock/stockList.jsp 로 뷰페이지 연결!"); // 자동으로 연결, 리턴타입이 void 이기때문.
		
	}// productListGET() method end
	// 상품관리 - 상품목록
	
	@RequestMapping(value="/stockWrite",method=RequestMethod.GET)
	public void stockWritetGET() {
		logger.debug("stockWriteGET() 호출![]~(￣▽￣)~*");
